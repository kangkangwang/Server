...
namespace SanNiuSignal.Basics
{
    ...
    public class FTxBase : ITxBase
    {
        ...
        private IPEndPoint _ipEndPoint; //终结点地址项目里面用
        private int _port;
        ...
        internal void sendMessage(StateBase stateOne, byte[] data)
        {
            ...
            var stateCode = new StateCode(PasswordCode._photographCode, data);
        ...
        internal virtual void Send(StateBase stateOne, byte[] data)
        {
        }
