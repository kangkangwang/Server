...
namespace SanNiuSignal.PasswordManage
{
    internal class EncryptionDecryptFile
    {
        ...
        internal static byte[] FileHeadEncryption(FileState fileSend)
        {
            ...
            var haveDate = new byte[15 + fileNameByte.Length];
        ...
        internal static byte[] FileSubjectEncryption(FileState fileSend, int bufferSize)
        {
            ...
            var haveDate = new byte[BufferSize];
            int haveDatelenth = 1;
            try
            {
            ...
            {
                return FileSevenEncryption(PasswordCode._sendUser, PasswordCode._fileCancel,
                    fileSend.FileLabel);
            }
            if (haveDatelenth <= 0)
        ...
        internal static byte[] FileSubjectDecrypt(FileState fileSend, byte[] receiveDate)
        {
            ...
            {
                return FileSevenEncryption(PasswordCode._receiveUser, PasswordCode._fileCancel,
                    fileSend.FileLabel);
            }
