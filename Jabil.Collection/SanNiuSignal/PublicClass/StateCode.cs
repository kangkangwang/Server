namespace SanNiuSignal.PasswordManage
{
    ...
    {
        private readonly byte[] _dateByte; //字节数据
        private readonly string _datestring; //文本数据
        private readonly byte[] _replyDate; //直接回复的数据
        private readonly int _sendDateLabel; //发送数据的标签
        private readonly byte _state; //状态码
